# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 08:54:28 2019
...
plt.subplot(611)
timeShift = 2.5*(1+signal.sawtooth((t_period*24)-200,0.95))
...
shiftCoeffs = fourierCoeffs(timeShift,harmonics)
timeShiftedWave = reconstruct(len(timeShift),shiftCoeffs)
...
plt.subplot(616)
plt.plot(t_period,timeShiftedWave)
plt.ylabel("shifted")
